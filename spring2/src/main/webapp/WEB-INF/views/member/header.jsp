...
<body>
    ...
    <nav class="navi">
      <ul>
        ...
        <li><a href="end_party_list.do" style="margin-left:150%;">종료파티방</a></li>
        <li><a href="board_list.do" style="margin-left:250%;">커뮤니티</a></li>
        <li><a href="notice_list.do" style="margin-left:350%;">공지사항</a></li>

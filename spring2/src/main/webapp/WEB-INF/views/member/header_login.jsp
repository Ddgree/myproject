...
<body>
	<div class="header">
		...
		<c:choose>
			<c:when test="${member.member_id eq 'admin' }">
				<ul class="topnavM">
					<li class="dropdown" style="float: right"><a class="dropbtn2">${sessionScope.member.member_nickname}님!<br>환영합니다!
					</a>
						<div class="dropdown-content2" style="float: right">
							<a class="mypage2"><input class="header" type="button"
								value="마이페이지" onclick="location='member_mypage.do'" /></a> <a
								class="mypage2"><input class="header" type="submit"

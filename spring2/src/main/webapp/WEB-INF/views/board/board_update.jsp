...
$(document).ready(function(){
	$("input:radio[name='board_division'][value='${read.board_division}']").attr("checked",true);
});
</script>
</head>
	...
	<div id="board_write" align="center">
		...
		<form method="post" action="board_update_ok.do"
			...
			<table id="board_write_table" border=1>
				...
				<tr>
					<th>구분</th>
					<td><input type="radio" name="board_division" id="board_division_normal" class="input_box" value="일반" /> 일반
						<input type="radio" name="board_division" id="board_division_review" class="input_box" value="후기" /> 후기
					</td>
				</tr>

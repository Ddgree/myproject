...
<div align="center">
		<c:forEach items="${rlist}" var="rl">
						<div id="td_${rl.reboard_rno}">${rl.reboard_content}</div>
						<div id="btn_${rl.reboard_rno}">
						<button type="button" class="edit1" id="${rl.reboard_rno}">
							<i class="fa-solid fa-check fa-lg"></i></button>
							&nbsp;|&nbsp; 
						<button type="button" onclick="del(${rl.reboard_rno},${rl.reboard_bno})">
